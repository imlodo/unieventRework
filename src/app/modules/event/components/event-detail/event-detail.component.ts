...
import { allEventList } from '../../../../core/utility/global-constant';
...
export class EventDetailComponent implements AfterViewInit {
  ...
  getGroupEvents(n_group_id: number) {
    let groupEvents = allEventList.filter(el => el.n_group_id == n_group_id && el.n_id != this.n_id);
    this.elc.eventList = groupEvents;
